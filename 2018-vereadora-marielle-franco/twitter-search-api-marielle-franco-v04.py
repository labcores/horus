...
for q in query:
        ...
        while(continua == 1):
                try:
                        ...
                        vereadoraMarielleFranco20180417 = json.loads(data)
                        for tweet in vereadoraMarielleFranco20180417['statuses']:
                                                        
                                db.vereadoraMarielleFranco20180417.update({'id': tweet['id']},tweet, upsert=True)
