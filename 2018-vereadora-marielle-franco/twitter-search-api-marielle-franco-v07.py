...
for q in query:
        ...
        while(continua == 1):
                try:
                        ...
                        vereadoraMarielleFranco20180516 = json.loads(data)
                        for tweet in vereadoraMarielleFranco20180516['statuses']:
                                                        
                                db.vereadoraMarielleFranco20180516.update({'id': tweet['id']},tweet, upsert=True)
