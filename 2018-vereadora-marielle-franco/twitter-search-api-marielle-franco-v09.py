...
for q in query:
        ...
        while(continua == 1):
                try:
                        ...
                        vereadoraMarielleFranco20180601 = json.loads(data)
                        for tweet in vereadoraMarielleFranco20180601['statuses']:
                                                        
                                db.vereadoraMarielleFranco20180601.update({'id': tweet['id']},tweet, upsert=True)
