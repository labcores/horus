...
for q in query:
        ...
        while(continua == 1):
                try:
                        ...
                        vereadoraMarielleFranco20180609 = json.loads(data)
                        for tweet in vereadoraMarielleFranco20180609['statuses']:
                                                        
                                db.vereadoraMarielleFranco20180609.update({'id': tweet['id']},tweet, upsert=True)
