...
for q in query:
        ...
        while(continua == 1):
                try:
                        ...
                        vereadoraMarielleFranco20180502 = json.loads(data)
                        for tweet in vereadoraMarielleFranco20180502['statuses']:
                                                        
                                db.vereadoraMarielleFranco20180502.update({'id': tweet['id']},tweet, upsert=True)
