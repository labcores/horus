...
for q in query:
        ...
        while(continua == 1):
                try:
                        ...
                        vereadoraMarielleFranco20180410 = json.loads(data)
                        for tweet in vereadoraMarielleFranco20180410['statuses']:
                                                        
                                db.vereadoraMarielleFranco20180410.update({'id': tweet['id']},tweet, upsert=True)
